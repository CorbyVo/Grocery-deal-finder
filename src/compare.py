...
def compare_basket(shopping_list, offers_df):
    ...
    basket_summary["requested_items"] = len(set(shopping_list)) # convert the list to set to remove the duplicates, then count how many items there
...
if __name__ == "__main__": # run the code below only if this file is executed directly
    ...
    matched_offers, summary = compare_basket(shopping_list, offers_df)
